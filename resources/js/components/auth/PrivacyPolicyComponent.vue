<template>
    <div class="policy-box">
        <div class="white-box">
            ...
            <p> Built the AmarSteps app as a Commercial app. This SERVICE is provided by
            ...
            <p>The terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, which is
                accessible at AmarSteps unless otherwise defined in this Privacy Policy.
            </p>
...
<script>
    import BlankLayout from "~/components/layouts/BlankLayoutComponent.vue";
    export default {
        data: () => ({
            //
        }),
